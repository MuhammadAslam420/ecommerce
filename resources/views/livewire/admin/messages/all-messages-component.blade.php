        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-title-wrapper">
                <div class="page-title-box">
                    <p>All Available Customer Mesages</p>
                                        ...
                                        <td class="relative ">
                                            ...
                                            <div class="action-option ">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);" onclick="confirm('Are You Sure, You want to delete the Coupon!.') || event.stopImmediatePropagation()" wire:click.prevent="deleteMessage('{{ $msg->id }}')"><i class="fa fa-trash mr-2 "></i>Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
