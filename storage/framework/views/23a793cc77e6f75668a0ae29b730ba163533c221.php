 <aside class="sidebar-wrapper">
     <div class="logo-wrapper">
         <a href="<?php echo e(route('admin.dashboard')); ?>" class="admin-logo">
             <img src="<?php echo e(asset('admin/assets/images/logo.png')); ?>" alt="" class="sp_logo">
             <img src="<?php echo e(asset('admin/assets/images/mini_logo.png')); ?>" alt="" class="sp_mini_logo">
         </a>
     </div>
         ...
         <ul class="main-menu">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.home_page_categories')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    Home Page Category
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.mega_menu_categories')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.add_brand')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    Add Brand
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.seo.view')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    View
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.seo.create')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    Create
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.page.view')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    View
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.orders.delivered')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    Delivered
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.orders.dispatched')); ?>">
                                <span class="icon-dash">
                                </span>
                                <span class="menu-text">
                                    Dispatched
             ...
             <li>
                 ...
                 <ul class="sub-menu">
                     ...
                     <li>
                         <a href="<?php echo e(route('admin.subscribe_mails')); ?>">
                             <span class="icon-dash">
                             </span>
                             <span class="menu-text">
                                 Subscribe Mail
                     ...
                     <li>
                         <a href="<?php echo e(route('admin.promotion_mails')); ?>">
                             <span class="icon-dash">
                             </span>
                             <span class="menu-text">
                                 Promotion Mail
             ...
             <li>
                 <a href="<?php echo e(route('admin.add_attribute')); ?>">
                     <span class="icon-menu feather-icon">
                         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<?php /**PATH C:\Users\Work\Desktop\Data\TheMovers\ecommerce-laravel-9\resources\views/components/aside.blade.php ENDPATH**/ ?>