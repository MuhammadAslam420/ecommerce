          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="card ad-info-card">
                  <div class="card-body dd-flex align-items-center">
                      <div class="icon-info">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                              <g id="hand_&#xB7;_ecommerce_&#xB7;_shopping_&#xB7;_online_&#xB7;_sale" data-name="hand &#xB7; ecommerce &#xB7; shopping &#xB7; online &#xB7; sale">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="card ad-info-card">
                  <div class="card-body dd-flex align-items-center">
                      ...
                      <div class="icon-info-text">
                          <h5 class="ad-title">Today Revenue</h5>
                          <h4 class="ad-card-title">{{number_format($today_revenue,2)}}</h4>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12">
              <div class="card chart-card">
                  <div class="card-header">
                      <h4 class="has-btn">Total Revanue <span>
                      <button type="button" class="btn btn-primary squer-btn sm-btn" wire:click="orderExport">Download</button></span></h4>
                  </div>
                  <div class="card-body">
                      <div class="row">
                                      ...
                                      <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                          <div class="revenue-info-wrap">
                                              <table>
                                                  <tbody>
                                                      <tr>
                                                          <td><i class="fa fa-chart-bar mr-2 icon-only"></i>Total Sales</td>
                                                          <td>{{$weekly_sale}}</td>
                                                      </tr>
                                                      <tr>
                                                          <td><i class="fa fa-user-o mr-2 icon-only"></i>Total Customers</td>
                                                          <td>{{$weekly_user}}</td>
                                                      </tr>
                                                      <tr>
                                                          <td><i class="fa fa-gift mr-2 icon-only"></i>Total Orders</td>
                                                          <td>{{$weekly_orders}}</td>
                                                      </tr>
                                                      <tr>
                                                          <td><i class="fa fa-signal mr-2 icon-only"></i>Total Reviews</td>
                                                          <td>{{$weekly_reviews}}</td>
                                                      </tr>
                                                  </tbody>
                                              </table>
                                          </div>
                                          ...
                                          <div class="revenue-info-wrap">
                                              <table>
                                                  <tbody>
                                                    ...
                                                    <tr>
                                                        <td><i class="fa fa-gift mr-2 icon-only"></i>Total Orders</td>
                                                        <td>{{$monthly_orders}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><i class="fa fa-signal mr-2 icon-only"></i>Total Reviews</td>
                                                        <td>{{$monthly_reviews}}</td>
                                                    </tr>
                                                  </tbody>
                                              </table>
                                          </div>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <span class="img-thumb ">
                                                  <img src="{{asset('admin/assets/images/1.jpg')}} " alt=" ">
