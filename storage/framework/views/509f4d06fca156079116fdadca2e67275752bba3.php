                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h5>All Available&nbsp;(<?php echo e($pages->count()); ?>)</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="relative ">
                                            ...
                                            <div class="action-option ">
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo e(route('admin.seo.edit',['id'=>$page->id])); ?>"><i class="fa fa-edit mr-2 "></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a wire:click="pageDelete(<?php echo e($page->id); ?>)"><i class="fa fa-trash mr-2 "></i>Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
...
<?php /**PATH C:\Users\Work\Desktop\Data\TheMovers\ecommerce-laravel-9\resources\views/livewire/admin/pages/view-component.blade.php ENDPATH**/ ?>