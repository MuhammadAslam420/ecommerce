                             ...
                             <div class="product-cart-wrap mb-30">
                                 ...
                                 <div class="product-content-wrap">
                                     ...
                                     <div class="product-action-1 show">
                                         <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store('{{$product->id}}','{{$product->name}}',{{$product->sale_price}})"><i class="fa fa-shopping-bag"></i></a>
                                     </div>
                                 </div>
                             </div>
                         </div>
                                                 ...
                                                 <div class="detail-info">
                                                     ...
                                                     <div class="clearfix product-price-cover">
                                                         <div class="product-price primary-color float-left">
                                                             ...
                                                             <span class="save-price  font-md text-dark ml-15">{{number_format(($product->sale_price / $product->price)*100,0) }}% Off</span>
                                                         </div>
                                                     </div>
