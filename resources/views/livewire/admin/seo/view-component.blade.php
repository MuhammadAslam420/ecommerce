                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h5>All Available&nbsp;({{$seos->count()}})</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="relative ">
                                            ...
                                            <div class="action-option ">
                                                <ul>
                                                    <li>
                                                        <a href="{{route('admin.seo.edit',['id'=>$seo->id])}}"><i class="fa fa-edit mr-2 "></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a wire:click="seoDelete({{ $seo->id }})"><i class="fa fa-trash mr-2 "></i>Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
