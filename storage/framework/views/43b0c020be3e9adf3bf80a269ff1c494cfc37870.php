<div class="cart-wrapper header-links">
    <a href="javascript:void(0);" class="cart-info">
        ...
        <span class="item-count"><?php echo e($notifications->count()); ?></span>
    </a>
    <div class="of-notification-comment">
        <div class="of-nt-text">
            <h5>New Orders</h5>
            <h6>You have <?php echo e($notifications->count()); ?> No's of orders</h6>
        </div>
                        ...
                        <div class="int-table-quantity">
                            <div class="quantity-wrapper">
                                <div class="quantity-qty">
                                    <h5><?php echo e($notification->total); ?></h5>
                                </div>
                                <button class="btn btn-warning" wire:click="markAsRead(<?php echo e($notification->id); ?>)">Order</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="int-sop-cart-btn">
            <a href="<?php echo e(route('admin.orders')); ?>" class="ad-btn">View Orders</a>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Work\Desktop\Data\TheMovers\ecommerce-laravel-9\resources\views/livewire/order-notifications.blade.php ENDPATH**/ ?>